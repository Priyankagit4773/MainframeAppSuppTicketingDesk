<?php
  $pageTitle = "MainFrame Application Support";
?>
...
if (isset($_GET['del']) && isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
    $id = $_GET['del'];
    ...
    echo '<script>alert("Access Denied: Only admins can delete tickets.");</script>';
}
...
<div id="content-wrapper">
  ...
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">MainFrame Application Support</li>
    </ol>
