...
<body class="bg-dark">
  ...
  <div class="text-center mb-3">
    <img src="css/logo.jpg" alt="MainFrame" style="max-width: 200px;> alt="MainFrame" style="max-width: 150px;">
  </div>
  <div class="card-header text-center font-weight-bold">Application Support</div>
  <div class="card-body">
